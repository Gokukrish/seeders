...
@section('content')
    ...
    <div class="card font-weight-bold">
        ...
        <div class="card-body">
            <form action="{{ route('form4.store') }}" method="POST">
                @csrf
                
                <div class="row">
                <div class="form-group col-md-6">
                <label for="period">Report for the period  </label>
                <input type="month" name="period" placeholder="Report for the period  " class="form-control" />
                </div>
                ...
                <input type="text" name="Total_quantity" placeholder="Details of total quantity imported/ manufactured (Metric tonnes)" class="form-control" />
                </div>
                </div>
                ...
                <input type="text" name="Quantity_utilized" placeholder="Quantity utilized for formulations (Metric tonnes) " class="form-control" />
                </div>
                <div class="form-group col-md-6">
                    <label for="Quantity_sold">Quantity sold </label>
                    <input type="text" name="Quantity_sold" placeholder="Quantity utilized for formulations (Metric tonnes) " class="form-control" />
                </div>
                </div>

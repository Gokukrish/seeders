            ...
            <form action="{{ route('form2.update',$form2->id) }}" method="POST">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="month" name="Date" value="{{$form2->Date}}"  class="form-control" />
                    </div>

                    <div class="form-group col-md-6">
                        <label for="Retailer_name">Name of the Retailer to Whom supplied</label>
                        <select type="text" name="Retailer_name"  value="$form2->Retailer_name"
                            class="form-control">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <select type="text" name="Product_Name" value="{{$form2->Product_Name}}" class="form-control">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="Invoice" value="{{$form2->Invoice}}" class="form-control" />
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="date" name="Invoice_Date"  value="{{$form2->Invoice_Date}}" class="form-control" />
                    </div>

                    <div class="form-group col-md-6">
                        <label for="Quantity_supplied">Quantity supplied</label>
                        <input type="text" name="Quantity_supplied" value="{{$form2->Quantity_supplied}}" class="form-control" />
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <select type="text" name="company" value="{{$form2->company}}" class="form-control">
                            <option>MFL</option>
                            <option>SPIC</option>
                            <option>FACT</option>

...
@endif
            <form action="{{ route('fertilizer.store') }}" method="POST">
                ...
                <input type="month" name="Date" placeholder="Enter the Date" class="form-control" />
                </div>
                
                <div class="form-group col-md-6">
                <label for="Product_Name">Enter the Product Name </label>
                <select type="text" name="Product_Name" placeholder="Enter the Product Name " class="form-control" >
                ...
                <input type="text" name="Opening_Stock" placeholder="Enter the Opening Stock" class="form-control" />
                </div>
                
                <div class="form-group col-md-6">
                <label for="Closing_Stock">Enter the Closing Stock</label>
                <input type="text" name="Closing_Stock" placeholder="Enter the Closing Stock" class="form-control" />
                </div>
                </div>
                ...
                <input type="text" name="Cash_Transaction" placeholder="Enter the Quantity Sold through Cash Transaction" class="form-control" />
                </div>
                
                <div class="form-group col-md-6">
                <label for="Cashless_Transaction">Enter  the Quantitiy sold Trough Cashless Transaction</label>
                <input type="text" name="Cashless_Transaction" placeholder="Enter  the Quantitiy sold Trough Cashless Transaction" class="form-control" />
                </div>
                </div>
                ...
                <input type="text" name="No_of_Cash" placeholder="Enter the No. of Cash Transaction" class="form-control" />
                </div>
                
                <div class="form-group col-md-6">
                <label for="No_of_Cashless">Enter  the No. of  Cashless Transaction</label>
                <input type="text" name="No_of_Cashless" placeholder="Enter  the No. of  Cashless Transaction" class="form-control" />
                </div>
                </div>

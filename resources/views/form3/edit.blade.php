            ...
            <form action="{{ route('form3.update', $form3->id) }}" method="POST">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="month" name="Date" value="{{$form3->Date}}" class="form-control" />
                    </div>

                    <div class="form-group col-md-6">
                        <label for="Insecticide">Particulars of the Insecticide</label>
                        <select type="text" name="Insecticide" 
                            class="form-control">
                            <option>{{$form3->Insecticide}}</option>
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="CIB_Reg_NO" value="{{$form3->CIB_Reg_NO}}" class="form-control" />
                    </div>

                    <div class="form-group col-md-6">
                        <label for="date_of_receipt">CIR Registration Month and Year</label>
                        <input type="month" name="date_of_receipt" value="{{$form3->date_of_receipt}}"
                            class="form-control" />
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <select type="text" name="Manufacturer_name"
                             class="form-control">
                             <option>{{$form3->Manufacturer_name}}</option>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select type="text" name="Suplier_name"
                             class="form-control">
                             <option >{{$form3->Suplier_name}}</option>
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="Batch_no" value="{{$form3->Batch_no}}" class="form-control" />
                    </div>

                    <div class="form-group col-md-6">
                        <label for="Date_of_Manufacturer">Date of Manufacture</label>
                        <input type="date" name="Date_of_Manufacturer" value="{{$form3->Date_of_Manufacturer}}"
                            class="form-control" />
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="date" name="Date_of_expiry" value="{{$form3->Date_of_expiry}}" class="form-control" />
                    </div>
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="Quantity" value="{{$form3->Quantity}}" class="form-control" />
                    </div>
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="Reciept_for_Month" value="{{$form3->Reciept_for_Month}}"
                            class="form-control" />
                    </div>

                    <div class="form-group col-md-6">
                        <label for="Distributed_Month">Distributed for the month</label>
                        <input type="text" name="Distributed_Month" value="{{$form3->Distributed_Month}}"
                            class="form-control" />
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="Balance" value="{{$form3->Balance}}" class="form-control" />
                    </div>
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="Remarks" value="{{$form3->Remarks}}" class="form-control" />
                    </div>
                </div>
                <div class="p-3 mb-4">
